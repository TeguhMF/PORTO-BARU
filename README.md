...
- **Scroll Animations**: Efek *fade-in* saat pengguna melakukan scrolling.
...
- **Vanilla JavaScript**: Logika interaktif tanpa library eksternal (Dark mode, Scroll Observer, WA Integration).
...
├── style.css    # Animasi kustom & scrollbar styling
├── script.js   # Logika interaktif & integrasi WhatsApp
